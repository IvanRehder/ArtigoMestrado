...
%
%The barplots of the two groups are presented in Figure \ref{fig:barplot_gsr_avg_4_scene_blind_sight}. 
...
%        \centering
%        \includegraphics[width = \linewidth]{Resultados/GSR/Figuras/pdf/barplot_gsr_avg_4_scene_blind.pdf}
%        \subcaption{Blind participants.}
%        \label{fig:barplot_gsr_avg_4_scene_blind}
%    \end{minipage}
%    \begin{minipage}{\linewidth}
%        \centering
%        \includegraphics[width = \linewidth]{Resultados/GSR/Figuras/pdf/barplot_gsr_avg_4_scene_sight.pdf}
...
%Figures \ref{fig:qqplot_gsr_two_way_sight} and \ref{fig:residplot_gsr_two_way_sight} bring the QQ Plot and residual distribution. 
...
%    \begin{minipage}{0.45\linewidth}
%        \centering
%        \includegraphics[width = \linewidth]{Resultados/GSR/Figuras/pdf/qqplot_gsr_two_way_sight.pdf}
...
%    \begin{minipage}{0.45\linewidth}
%        \centering
%        \includegraphics[width = \linewidth]{Resultados/GSR/Figuras/pdf/residplot_gsr_two_way_sight.pdf}
