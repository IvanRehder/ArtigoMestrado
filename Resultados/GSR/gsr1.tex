...
%\begin{figure}[!htb]
%    \centering
%    \includegraphics[width = \linewidth]{Resultados/GSR/Figuras/pdf/barplot_gsr_avg_5_scene_blind.pdf}
...
%Figures \ref{fig:qqplot_gsr_two_way_blind} and \ref{fig:residplot_gsr_two_way_blind} shows the QQ plot and the residual distribution. 
...
%        \centering
%        \includegraphics[width = \linewidth]{Resultados/GSR/Figuras/pdf/qqplot_gsr_two_way_blind.pdf}
...
%    \begin{minipage}{0.45\linewidth}
%        \centering
%        \includegraphics[width = \linewidth]{Resultados/GSR/Figuras/pdf/residplot_gsr_two_way_blind.pdf}
